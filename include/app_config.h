...
#if (defined(FIXTURE_DEFAULT) + defined(FIXTURE_PROD) + defined(FIXTURE_SCANFIL_SAFETY)) > 1
#error "Only one fixture can be selected"
#endif

#if !defined(FIXTURE_DEFAULT) && !defined(FIXTURE_PROD) && !defined(FIXTURE_SCANFIL_SAFETY)
