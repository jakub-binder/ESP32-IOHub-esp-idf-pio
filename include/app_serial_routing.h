...
#define APP_SERIAL_DEBUG_ENDPOINT        APP_SERIAL_ENDPOINT_USB_CDC
#else
#define APP_SERIAL_DEBUG_ENDPOINT        APP_SERIAL_ENDPOINT_UART0
#endif
#define APP_SERIAL_PROD_ENDPOINT         APP_SERIAL_ENDPOINT_UART1
#elif defined(APP_MODE_PROD)
#define APP_SERIAL_DEBUG_ENDPOINT        APP_SERIAL_ENDPOINT_UART1
#if BOARD_HAS_USB_CDC
#define APP_SERIAL_PROD_ENDPOINT         APP_SERIAL_ENDPOINT_USB_CDC
#else
#define APP_SERIAL_PROD_ENDPOINT         APP_SERIAL_ENDPOINT_UART0
#endif
#else
