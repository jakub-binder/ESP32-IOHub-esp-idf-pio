...
## Pravidla pro analýzu repozitáře

Při analýze repozitáře musí agent dodržovat následující pravidla:

- nevytvářet žádné nové soubory
- neupravovat žádné existující soubory
- neprovádět žádné commity
- nespouštět změny v git (add, commit, push)
- nezasahovat do struktury projektu

Pokud není výslovně požadována změna:
agent vrací pouze textovou odpověď
...
### 2. IMPLEMENTACE (pouze na explicitní pokyn)
- může upravovat soubory
- může vytvářet nové soubory
- musí dodržovat architekturu projektu

Pokud není jasně řečeno, že má agent něco implementovat:
vždy použít režim ANALÝZA
